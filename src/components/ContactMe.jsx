...
function ContactUs() {
  return (
    <div
    className=" bg-[#101010] mx-auto px-4 py-20 items-center " id="contact-me"
    >
      <Container>
        <div className="grid grid-cols-1  gap-8 md:grid-cols-2">
          <div className="space-y-7 w-full md:w-[400px] ">
            <div className="pb-">
              ...
              <h2 className="font-semibold text-5xl uppercase text-white ">Get in Touch</h2>
            </div>
            <div className="flex space-x-4 text-white">
              <i className="fa-solid fa-mobile-button fa-2xl"></i>
              <div className="">
                <p className="text-xl font-semibold uppercase mb-2 text-[#279EFF]">Phone</p>
                <span className="text-[#ccc]">3281675</span>
              </div>
            </div>
            ...
            <div className="flex space-x-4 text-white">
              ...
              <div className="">
                <p className="text-xl font-semibold uppercase mb-2 text-[#279EFF]">Email</p>
                <span  className="text-white" >mamfatoudrammeh2002@gmail.com</span>
              </div>
            </div>
            <div className="flex space-x-4 text-white">
              <i className="fa-solid fa-location-dot fa-2xl"></i>
              <div className="">
                <p className="text-xl font-semibold uppercase mb-2 text-[#279EFF]">Address</p>
